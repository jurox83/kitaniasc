...
Installing "kitaniaSC" can be done either by searching for "kitaniaSC" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
